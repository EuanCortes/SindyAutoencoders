...
#BSUB -W 24:00
#BSUB -o batch_output/PredPrey_GPU_%J.out
#BSUB -e batch_output/PredPrey_GPU_%J.err
...
echo "Running PredPrey training script..."
python -u trainPredPrey.py
